...
- The selection rubric, category taxonomy, and usefulness scoring may need tuning after the first few batches.

## Recommended Next Steps

- Fill `research/registry/CANDIDATE_QUEUE.md` with the first scouting batch of up to 4 Kotlin repositories.
- Create the first batch note under `research/batches/`.
