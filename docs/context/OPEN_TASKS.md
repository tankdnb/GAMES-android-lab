...
- Start with one Android-native Kotlin game project.
- Add one engine or rendering-focused Kotlin repository.
- Add one technically unusual wildcard repository if it still has strong research yield.

## Deferred

- Add project-specific runbooks only after a real recurring workflow exists to document.
